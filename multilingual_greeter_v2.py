...
def language_input() -> int:
    ...
    """
    lang_option = input('please choose a language?\n')

    return int(lang_option)
...
def get_name_input(name_prompt_options: Dict[int, str], lang_choice: int) -> str:
    ...
    value = name_prompt_options.get(lang_choice)
    return value
...
def greet(name: str, greetings_options: Dict[int, str], lang_choice: int) -> None:
    ...
    :return:
    """
    greet_user = greetings_options.get(lang_choice) + " " + name
